...
public class SentimentAnalyzer {
    ...
    public static Map<String, Integer> getDefaultValues() {
    	return Maps.newHashMap(ImmutableMap.of("Very positive", 0, "Positive", 0, "Neutral", 0, "Negative", 0, "Very negative", 0));
    }
